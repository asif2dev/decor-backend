...
return [
    ...
    */
    ...
    'searchableAttributes' => ['title', 'description', 'palette', 'space.name', 'designType.name', 'professional.companyName'],
    ...
    */
    ...
    'attributesForFaceting' => ['designType.name', 'space.name', 'palette'],
